...
export default function Survey() {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      usedLaundry: guest.segment === "a" ? usedLaundry === "yes" : undefined,
      washFold: guest.segment === "b" ? undefined : washFold,
